        ...
        <section class="sec0001 wrapper wow fadeInUp" data-wow-delay=".8s">
            ...
            <div class="image-part slick-content">
                <div class="image-item">
                    <img src="{{ $data->img_1 ? $data->img_1 : './assets/img/no-image.png' }}" alt="{{ $data->c_name }}">
                </div>
                <div class="image-item">
                    <img src="{{ $data->img_2 ? $data->img_2 : './assets/img/no-image.png' }}" alt="{{ $data->c_name }}">
                </div>
                <div class="image-item">
                    <img src="{{ $data->img_3 ? $data->img_3 : './assets/img/no-image.png' }}" alt="{{ $data->c_name }}">
                </div>
            </div>
        </section>
